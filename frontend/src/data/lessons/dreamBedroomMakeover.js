...
export const act2 = {
  ...
  activity: {
    ...
    expenses: [
      { id: 'stationery', name: 'School stationery',        amount: 300, art: 'stationery', bucket: 'needs',   feedback: 'Yes! School supplies are a Need.' },
      { id: 'buspass',    name: 'Bus pass (monthly)',       amount: 400, art: 'buspass',    bucket: 'needs',   feedback: 'Correct — transport to school is essential.' },
      { id: 'streaming',  name: 'Streaming app',            amount: 149, art: 'streaming',  bucket: 'wants',   feedback: 'Right! Entertainment is a Want.' },
      { id: 'snacks',     name: 'Canteen snacks',           amount: 600, art: 'snacks',     bucket: 'wants',   grey: true, feedback: 'Snacks could be a Need (food) or a Want (treat). Since Kabir has lunch covered separately, we count snacks as a Want here.' },
      { id: 'earphones',  name: 'New earphones',            amount: 800, art: 'earphones',  bucket: 'wants',   feedback: 'A Want — the old ones still work fine.' },
      { id: 'lunch',      name: 'Lunch on school days',     amount: 900, art: 'lunch',      bucket: 'needs',   feedback: 'Definitely a Need — food is always a Need.' },
      { id: 'movie',      name: 'Movie outing with friends',amount: 350, art: 'movie',      bucket: 'wants',   feedback: 'A fun Want — social and enjoyable, not essential.' },
      { id: 'piggy',      name: 'Piggy bank deposit',       amount: 500, art: 'piggy',      bucket: 'savings', feedback: 'Great! Saving counts as the 20% bucket.' },
    ],
    leftover: 1001,
